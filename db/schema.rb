...
ActiveRecord::Schema.define(version: 2020_01_19_075525) do
  ...
  create_table "follow_relationships", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
